...
if (empty($scheme)) {
  ...
  if (strpos($url, "//") === 0) {
    ...
    die('Error: Detected a "' . $scheme . '" URL. TrilleplayProxy exclusively supports http[s] URLs.');
}
